        ...
        <aside className="flex flex-col w-16 border-r-2">
            <div className="flex flex-col text-purple-contrast max-w-min p-2 gap-2 fixed top-0">
                ...
                <nav className="flex flex-col space-y-2">
                    <NavLink to="/" onClick={() => setActiveMenu('/')} className={`flex gap-2 p-2 rounded-lg cursor-pointer transition ease-in-out duration-200 ${activeMenu === '/' ? 'bg-purple-contrast text-amber' : 'hover:bg-purple-contrast hover:text-amber'}`}>
